package org.teqmonic.springmultipledatabase.primary.dbconfig;
...
@EnableJpaRepositories(
        ...
        basePackages = {"org.teqmonic.springmultipledatabase.primary.repo"}
)
public class PrimaryDatabaseConnection {
    ...
    public LocalContainerEntityManagerFactoryBean primaryEntityManagerFactory(
        ...
        return builder
                ...
                .packages("org.teqmonic.springmultipledatabase.primary.model")
                .properties(props)
                .build();
    }
